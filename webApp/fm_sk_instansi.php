...
<body style="background-color:	#F0FFFF">
    ...
    <a class="navbar-brand" href="index.php">
        ...
        <div class="container" style="background-color:white; margin-top:6%; margin-bottom:10%;">
            <header>
            <br>
                <h1><center>Form Voluntary Instansi<center></h1>
            <br>
            </header>
            <div class="row" style="margin-top:2%;">
                ...
                <div class="card-body">
            <form action="proses-tambah-ski.php" method="POST" enctype="multipart/form-data">
                <fieldset>
                    <div class="form-group">
                        <label for="form-field-select-3">Nama Pengadu/Pelapor <font color="red">*</font></label>
                        <div>
                            <input type="text" id="nama_pelapor" name="nama_pelapor" placeholder="Nama Pengadu/Pelapor" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="form-field-select-3">Nama Instansi<font color="red">*</font></label>
                        <div>
                            <input type="text" id="instansi" name="instansi" placeholder="Nama Instansi" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="form-field-select-3">Alamat Instansi<font color="red">*</font></label>
                        <div>
                    ...
                    <div class="form-group">
                        <label for="form-field-select-3">Jumlah yang Dicurigai <font color="red">*</font></label>
                        <div>
                            <input type="number" id="jml_curiga" name="jml_curiga" placeholder="" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="form-field-select-3">Jenis Penyalahgunaan<font color="red">*</font></label>
                        <div>
                            <textarea class="form-control" id="jns_penyalahgunaan" name="jns_penyalahgunaan" placeholder="Jenis Penyalahgunaan" required></textarea>
                        </div>
                    </div>
