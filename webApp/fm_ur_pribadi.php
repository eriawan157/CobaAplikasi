    ...
    <a class="navbar-brand" href="index.php">
        ...
        <div class="container" style="background-color:white; margin-top:6%; margin-bottom:10%;">
            ...
            <br>
                ...
                <h2><center>Pribadi<center></h2>
            <br>
            </header>
            <div class="row" style="margin-top:2%;">
                <div class="col-7">
            <form action="proses-tambah-urp.php" method="POST" enctype="multipart/form-data">
                <fieldset>
                    <div class="form-group">
                        <label for="form-field-select-3">Foto KTP <font color="grey">*max size = 1 Mb</font></label>
                        <div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="number" id="nmr_ktp" name="nmr_ktp" placeholder="Nomor KTP" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="date" id="tanggal_lhr" name="tanggal_lhr" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="form-field-select-3">Jenis Kelamin<font color="red">*</font></label>
                        <br>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <textarea class="form-control" id="keperluan" name="keperluan" placeholder="Keperluan"></textarea>
                        </div>
                    </div> 
                    <div class="form-group">
                        <label for="form-field-select-3">Lampiran Foto <font color="grey">*max size = 1 Mb</font></label>
                        <div>
