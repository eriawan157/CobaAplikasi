...
<body style="background-color:	#F0FFFF">
    ...
    <a class="navbar-brand" href="index.php">
        ...
        <div class="container" style="background-color:white; margin-top:6%; margin-bottom:10%;">
            <header>
                <br>
                <h1><center>Form Permohonan Sosialisasi<center></h1>
                <br>
            </header>
            <div class="row" style="margin-top:2%;">
                ...
                <div class="card-body">
            <form action="proses-tambah-sos.php" method="POST" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="form-field-select-3">Nama Penyelenggara <font color="red">*</font></label>
                        <div>
                            <input type="text" id="nama_penyelenggara" name="nama_penyelenggara" placeholder="Nama Penyelenggara" class="form-control" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="form-field-select-3">Tanggal <font color="red">*</font></label>
                        <div>
                    ...
                    <div class="form-group">
                        <label for="form-field-select-3">Tempat <font color="red">*</font></label>
                        <div>
                            <textarea class="form-control" id="tempat" name="tempat" placeholder="Tempat Sosialisasi" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="nama_pemohon" id="nama_pemohon" placeholder="Nama Pemohon" class="form-control" required/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="form-field-select-3">Tema Kegiatan <font color="red">*</font></label>
                        <div>
                            <textarea class="form-control" name="tema_kegiatan" placeholder="Tema Kegiatan" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
